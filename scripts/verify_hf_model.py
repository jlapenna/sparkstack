...
def verify_model(repo_id):
    ...
    try:
        req = urllib.request.Request(url, headers={'User-Agent': 'SparkStack-Verification-Agent/1.0'})
        ...
        print(f"❌ ERROR: Repository '{repo_id}' not found or access denied (HTTP {e.code}). DO NOT RECOMMEND THIS MODEL.", file=sys.stderr)
        sys.exit(1)

...
from sparkstack.core.registry import ModelIDExtractor
from sparkstack.core.schemas import ComposeRegistryModel
...
class DockerServiceHandler:
    ...
    def apply_to_builders(
        ...
        context_window = int(model_info_map.get("context_window", DEFAULT_KV_CACHE_CEILING))

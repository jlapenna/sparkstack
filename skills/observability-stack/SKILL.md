...
- **Prometheus** (9090): Time-series database. Configuration is dynamically generated by `uv run python scripts/build_stack.py` and symlinked to `current/prometheus.yml`. Scrape interval is 15s.
